...
Or you can also build a simple webpage to display the result with http://leafletjs.com/[Leaflet], https://gist.github.com/sim51/409c769d0501956549221449ca845360[The story of an Omaha man who hated Muslims…until some Syrian refugees became his neighbors. wapo.st/2kFgG2o
like this one].
