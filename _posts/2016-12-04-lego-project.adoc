...
:project: lego
:neo4j-version: 3.0
:description: This project aims to create a referencial of all the lego sets, with theirs pieces based on Neo4j. So after, if you have a partial set, you will know wich piece to search to have a complete one.
:toc:
